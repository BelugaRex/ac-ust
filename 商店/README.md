...
| 文件 | 用途 |
| --- | --- |
| `CHROMEWEBSTORE.md` | 基本信息、双语短/长说明、`0.8.2` 更新说明、数据使用、权限理由、审核步骤与发布设置 |
...
2. 上传 `../releases/ac-ust-v0.8.2.zip`；ZIP 由 `../build.sh` 生成，不在本目录保存第二份。
3. 从 `CHROMEWEBSTORE.md` 复制对应语言的短说明、详细说明与 `0.8.2` 更新说明。
